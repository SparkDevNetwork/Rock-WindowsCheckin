...
Double click the CheckinClient project.
Change the `Version` node to the new version number.

In the CheckinClient.Installer project, open the `Package.wxs` file.
...
Rebuild the CheckinClient project.

Then publish CheckinClient.
